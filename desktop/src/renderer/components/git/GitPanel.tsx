        ...
        <div className="relative">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-white">{status?.current || 'main'}</span>
            </div>
            <div className="flex items-center gap-2">
              {status?.ahead ? (
              ...
              <div className="pb-2">
                {stagedFiles.map((file) => (
                  ...
                  >
                    ...
                    {getFileStatusBadge('added')}
                    <button
                      onClick={() => unstageFiles(projectPath, [file])}
          ...
          <div className="border-b border-white/5">
            ...
            >
              ...
              <div className="flex gap-1">
                <button
                  onClick={(e) => { e.stopPropagation(); discardChanges(projectPath, unstagedFiles.map(f => f.path)); }}
                ...
                <button
                  onClick={(e) => { e.stopPropagation(); stageFiles(projectPath, unstagedFiles.map(f => f.path)); }}
                  className="p-1 text-gray-400 hover:text-white hover:bg-white/10 rounded"
                  title="Stage All"
                >
          ...
          <div className="border-b border-white/5">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-gray-500">{untrackedFiles.length}</span>
              </div>
              <button
                onClick={(e) => { e.stopPropagation(); stageFiles(projectPath, untrackedFiles); }}
                className="p-1 text-gray-400 hover:text-white hover:bg-white/10 rounded"
                title="Stage All"
              >
                <Plus className="w-3 h-3" />
