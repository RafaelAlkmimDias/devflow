...
import { useSettingsStore, type TabSize } from '@/lib/stores/settingsStore';
import { SettingItem, SettingSection } from './SettingItem';

type SettingsTab = 'general' | 'editor' | 'terminal' | 'keyboard';
...
function KeyboardSettings() {
  ...
  const shortcuts = [
    { key: `${mod} + ,`, action: 'Open Settings' },
    { key: `${mod} + S`, action: 'Save File' },
    { key: `${mod} + P`, action: 'Quick Open' },
    { key: `${mod} + Shift + F`, action: 'Global Search' },
    { key: `${mod} + Shift + P`, action: 'Command Palette' },
    { key: `${mod} + B`, action: 'Toggle Sidebar' },
    { key: `${mod} + J`, action: 'Toggle Terminal' },
    { key: `${mod} + /`, action: 'Toggle Comment' },
